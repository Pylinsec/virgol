...
export default function Virgool_logo() {
  return (
    <svg width="35px" height="50px" viewBox="0 0 204 304">
      {/* <style type="text/css">
        .st0{(fill = "#Shape_1_")}, .st1{(filter = "#filter-3")}, .st2
        {(fill = "#FFFFFF")}
      </style> */}
      <filter
      ...
      >
        <stop offset="0" className="page_speed_853580598"></stop>
        <stop offset="1" className="page_speed_375852357"></stop>
      </linearGradient>
      <path
        id="Shape"
        className="st0"
